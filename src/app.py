...
"Basketball Team": {
    "description": "Team practices, drills, and inter-school competitions",
...
"Drama Club": {
    ...
    "max_participants": 25,
    "participants": ["sophia@mergington.edu", "elijah@mergington.edu"]
},
"Debate Team": {
    "description": "Practice formal debate formats and compete in tournaments",
    "schedule": "Fridays, 3:30 PM - 5:00 PM",
    "max_participants": 16,
    "participants": ["oliver@mergington.edu", "amelia@mergington.edu"]
},
"Science Olympiad": {
    "description": "Prepare for STEM challenges across biology, physics, and engineering",
